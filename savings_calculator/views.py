    ...
    def post(self, request):
        ...
        try:
            ...
            basic_params = {
                ...
                'keep_amount': basic_form.cleaned_data['keep_amount'],
            ...
            # 创建计算器并执行计算
            calculator = SavingsCalculator(basic_params, age_range_params, is_authenticated=request.user.is_authenticated)
